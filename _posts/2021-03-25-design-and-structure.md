...
After banging my head on the wall repeatedly and spending hours on the internet, still I was not able to implement how to make three seperate partitions in the main window. Then I found out about `frames()`.
